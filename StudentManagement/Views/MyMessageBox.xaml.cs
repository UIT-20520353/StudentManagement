...
namespace StudentManagement.Views
{
    ...
    {
        public MyMessageBox(string messageBoxText)
        {
            InitializeComponent();
        ...
        public MyMessageBox(string messageBoxText, string caption)
        {
            InitializeComponent();
        ...
        public MyMessageBox(string messageBoxText, string caption, MessageBoxButton button)
        {
            InitializeComponent();
        ...
        public MyMessageBox(string messageBoxText, string caption, MessageBoxButton button, MessageBoxImage icon)
        {
            InitializeComponent();
